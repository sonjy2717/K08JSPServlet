...
<body>
	...
	num3 div num4 : ${ num3 div num4 } <!-- 나눗셈에는 div를 쓸 수 있다. --> <br />
	num3 % num4 : ${ num3 % num4 } <br />
	num3 mod num4 : ${ num3 mod num4 } <!-- 나머지 연산에는 mod를 쓸 수 있다. -->
	
	<!-- EL에서 +는 덧셈연산만 가능하고 문자열의 연결에는 사용되지 않는다. -->
	<h3>+ 연산자는 덧셈만 가능</h3>
	num1 + "34" : ${ num1 + "34" } <br /><!-- 문자열 형태의 숫자는 자동형변환되어 연산됨 -->
	num2 + "이십" : \${ num2 + "이십" } <br /><!-- 숫자와 문자열은 연산 불가능 -->
	"삼십" + "사십" : \${ "삼십" + "사십" } <!-- 문자열과 문자열도 연산 불가능 -->
	
	<h3>비교 연산자</h3>
	num4 > num3 : ${ num4 gt num3 } <br />
	num4 < num3 : ${ num1 lt num3 } <br />
	num4 >= num3 : ${ num2 ge num4 } <br />
