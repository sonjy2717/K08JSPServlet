...
$(function() {
	$('#sido').change(function() {
		$.ajax({
			...
			dataType : "json",
			success : function(d) {
				console.log("콜백 데이터", d);
				var optionStr = "";
				optionStr += "<option value=''>-구/군 선택-</option>";
				//콜백받은 JSON 배열을 통해 each()메서드 실행
				$.each(d, function(index, data) {
					console.log(index, data);
					//JSON 배열의 크기만큼 option태그 생성
